                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-primary mb-4"><b>Iniciar Sesión</b></h1>
                                    </div>
                                    <form class="user" method="POST" action="UsuariosController.php">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="medium" href="UsuariosController.php?accion=register">Crea una cuenta de pet lovers!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
